...
const baseClasses =
  'inline-flex h-10 items-center justify-center gap-2 rounded-xl px-4 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zippy-ring disabled:cursor-not-allowed disabled:opacity-60';
